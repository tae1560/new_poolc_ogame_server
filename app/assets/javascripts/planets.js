...
//        $scope.init_planet(planet);
    ...
    $scope.init_planet = function(planet) {
        ...
        planet.number_of_cargo = Math.ceil(planet.resource/2/5000/5);
        planet.attack_address = "http://s119-en.ogame.gameforge.com/game/index.php?page=fleet1&galaxy="+planet.galaxy+"&system="+planet.system+"&position="+planet.position+"&type=1&mission=1&am203="+planet.number_of_cargo;
